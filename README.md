...
- Edit `autostart` script and make it executable, (worth mentioning that awesomewm has better performance in games with picom)
```
$ chmod +x ~/.config/awesome/autostart.sh
```

- Also dont forget to edit `.xinitrc`, maybe you have different monitor so you need different xrandr options
```
