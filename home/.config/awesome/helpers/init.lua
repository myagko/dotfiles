...
function helpers.has_common(t1, t2)
	local common = {}
...
function helpers.remove_nonindex(tbl, val)
...
function helpers.is_supported(file, formats)
...
function helpers.table_to_file(tbl, file)
