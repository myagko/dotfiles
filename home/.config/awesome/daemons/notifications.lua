...
local notifications_daemon = {}
local instance = nil

function notifications_daemon:toggle_silent()
...
function notifications_daemon:display(n)
	...
	if n.urgency == "critical" then
		...
		nicon.image = beautiful.notification_icon_alert
	end
end

local function new()
	local ret = gears.object {}
	gears.table.crush(ret, notifications_daemon, true)
