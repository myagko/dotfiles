...
launcher.sidebar_control_button = helpers.ui.create_hover_button {
...
launcher.sidebar_day_info_button = helpers.ui.create_hover_button {
...
launcher.sidebar_poweroff_button = helpers.ui.create_hover_button {
...
launcher.sidebar = wibox.widget {
	...
	forced_width = dpi(55),
	{
		...
		launcher.sidebar_poweroff_button,
		nil,
		{
			...
			launcher.sidebar_day_info_button,
			launcher.sidebar_control_button
		}
	}
}
