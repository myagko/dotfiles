...
local function new()
	...
	ret.sidebar_home_button = widgets.hover_button {
	...
	ret.sidebar_wallpapers_button = widgets.hover_button {
	...
	ret.sidebar = wibox.widget {
		...
		forced_width = dpi(55),
		{
			...
			nil,
			{
				...
				ret.sidebar_wallpapers_button,
				ret.sidebar_home_button,
			}
		}
	}
